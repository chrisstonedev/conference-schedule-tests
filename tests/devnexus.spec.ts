      ...
      day: 'Wednesday', times: [
        ...
        {time: '11:00', talks: [{room: 'Foyer', name: 'Morning Break'}]},
        {
          time: '11:30', talks: [
            ...
            {
              room: 'Sydney Marcus',
              name: 'Walking to School in the Snow or What to Do When You Aren\'t Building Bridges with Bricks',
            },
          ],
        },
        {time: '12:30', talks: [{room: 'Foyer', name: 'Lunch'}]},
        {
          time: '13:30', talks: [
            ...
            {room: '315', name: 'Patterns, Predictions, and Prescriptions'},
        ...
        {time: '14:30', talks: [{room: 'Foyer', name: 'Afternoon Break'}]},
        {
          time: '15:00', talks: [
            ...
            {room: '312', name: 'From Code To Production - How Developer Tools Make you Successful'},
        ...
        },
        {
          time: '16:00', talks: [
            ...
            {room: '312', name: 'Batch Processing Cloud Apps with Java'},
            {
              room: '313',
